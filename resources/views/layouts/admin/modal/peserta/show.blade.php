<div class="modal fade" id="show-{{ $data->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" value="{{ $data->tanggal_lahir }}" disabled>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label fw-bold">Alamat</label>
                        <textarea class="form-control" rows="2" disabled>{{ $data->alamat }}</textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-bold">Nama Sekolah</label>
                        <input type="text" class="form-control" value="{{ $data->nama_sekolah }}" disabled>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">NPSN</label>
                        <input type="text" class="form-control" value="{{ $data->npsn }}" disabled>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-bold">Tahun Lulus</label>
                        <input type="text" class="form-control" value="{{ $data->tahun_lulus }}" disabled>
                    </div>
                </div>
            </div>
