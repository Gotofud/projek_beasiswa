...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <!-- Modal Form Add data-->
                @include('layouts.admin.modal.reviewer.add')
                <!-- End Modal Add data -->
                <!-- Table -->
                        ...
                        <tbody>
                            ...
                            @foreach ($reviewer as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->email }}</td>
                                    <td>
                                        <span class="badge bg-primary text-white">Reviewer</span>
                                    </td>
                                    <td>
                                        <form action="{{ route('admin.reviewer.destroy', $data->id) }}" method="POST">
                                ...
                                <!-- Edit Modal Form -->
                                @include('layouts.admin.modal.reviewer.edit')
                                <!-- End Edit Modal -->
                            @endforeach
                            <!-- end row -->
                        </tbody>
