            ...
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-start">
                    ...
                    <div class="action">
                        ...
                        <a href="{{ route('admin.prodi.export') }}" type="button" class="btn btn-success btn-md text-white "><i
                                class=" ti ti-file-spreadsheet"></i>
                            Export Excel</a>
                        <a href="{{ route('admin.prodi.exportPDF') }}" type="button" class="btn btn-danger btn-md text-white "><i class=" ti ti-file-text"></i>
                            Export PDF</a>
                    </div>
                </div>
            </div>
