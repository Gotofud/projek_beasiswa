...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4"
            ...
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Manajemen Universitas</h4>
            ...
            <div class="card-body">
                <div class="d-sm-flex justify-content-between align-items-start">
                    ...
                    <div class="action">
                        ...
                        <a href="{{ route('admin.universitas.export') }}" type="button" class="btn btn-success btn-md text-white "><i
                                class=" ti ti-file-spreadsheet"></i>
                            Export Excel</a>
                        <a href="{{ route('admin.universitas.exportPDF') }}" type="button"
        ...
        <div class="card">
            <div class="card-body">
                <!-- Modal Form Add data-->
                @include('layouts.admin.modal.universitas.add')
                <!-- End Modal Add data -->
                <!-- Table -->
                        ...
                        <tbody>
                            ...
                            @foreach ($uni as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.universitas.destroy', $data->id) }}" method="POST">
                                ...
                                <!-- Edit Modal Form -->
                                @include('layouts.admin.modal.universitas.edit')
                                <!-- End Edit Modal -->
                            @endforeach
                            <!-- end row -->
                        </tbody>
